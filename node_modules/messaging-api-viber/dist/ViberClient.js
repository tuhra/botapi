...
class ViberClient {
    ...
    setWebhook(url, optionsOrEventTypes = {}) {
        const options = Array.isArray(optionsOrEventTypes)
            ...
            : optionsOrEventTypes;
        return this.callAPI('/set_webhook', Object.assign({ url }, options));
    }
    /**
    ...
    sendMessage(receiver, message) {
        return this.callAPI('/send_message', Object.assign({ receiver, sender: this.sender }, transformMessageCase(message)));
    }
    /**
    ...
    sendPicture(receiver, picture, options) {
        return this.sendMessage(receiver, Object.assign({ type: 'picture', text: picture.text, media: picture.media, thumbnail: picture.thumbnail }, options));
    }
    /**
    ...
    sendVideo(receiver, video, options) {
        return this.sendMessage(receiver, Object.assign({ type: 'video', media: video.media, size: video.size, thumbnail: video.thumbnail, duration: video.duration }, options));
    }
    /**
    ...
    sendLocation(receiver, location, options) {
        return this.sendMessage(receiver, Object.assign({ type: 'location', location }, options));
    }
    /**
    ...
    broadcastMessage(broadcastList, message) {
        return this.callAPI('/broadcast_message', Object.assign({ broadcastList, sender: this.sender }, transformMessageCase(message)));
    }
    /**
    ...
    broadcastPicture(broadcastList, picture, options) {
        return this.broadcastMessage(broadcastList, Object.assign({ type: 'picture', text: picture.text, media: picture.media, thumbnail: picture.thumbnail }, options));
    }
    /**
    ...
    broadcastVideo(broadcastList, video, options) {
        return this.broadcastMessage(broadcastList, Object.assign({ type: 'video', media: video.media, size: video.size, thumbnail: video.thumbnail, duration: video.duration }, options));
    }
    /**
    ...
    broadcastLocation(broadcastList, location, options) {
        return this.broadcastMessage(broadcastList, Object.assign({ type: 'location', location }, options));
    }
    /**
    ...
    getUserDetails(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const { user } = yield this.callAPI('/get_user_details', { id });
            return user;
        });
    }
    /**
    ...
    getOnlineStatus(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.callAPI('/get_online', { ids });
            return data.users;
        });
    }
}

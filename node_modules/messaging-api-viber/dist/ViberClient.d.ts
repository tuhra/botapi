...
export default class ViberClient {
     ...
     * ```
     */
    setWebhook(url: string, optionsOrEventTypes?: ViberTypes.EventType[] | {
        eventTypes?: ViberTypes.EventType[];
        sendName?: boolean;
        sendPhoto?: boolean;
    }): Promise<ViberTypes.SucceededResponseData<{
        eventTypes: ViberTypes.EventType[];
    }>>;
    /**
     ...
     * ```
     */
    removeWebhook(): Promise<ViberTypes.SucceededResponseData<{
        eventTypes: ViberTypes.EventType[];
    }>>;
    /**
     ...
     */
    sendMessage(receiver: string, message: ViberTypes.Message): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendText(receiver: string, text: string, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendPicture(receiver: string, picture: ViberTypes.Picture, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendVideo(receiver: string, video: ViberTypes.Video, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendFile(receiver: string, file: ViberTypes.File, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendContact(receiver: string, contact: ViberTypes.Contact, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendLocation(receiver: string, location: ViberTypes.Location, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendURL(receiver: string, url: string, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendSticker(receiver: string, stickerId: number, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    sendCarouselContent(receiver: string, richMedia: ViberTypes.RichMedia, options?: ViberTypes.MessageOptions): Promise<ViberTypes.SucceededResponseData<{
        messageToken: number;
    }>>;
    /**
     ...
     * ```
     */
    broadcastMessage(broadcastList: string[], message: ViberTypes.Message): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastText(broadcastList: string[], text: string, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastPicture(broadcastList: string[], picture: ViberTypes.Picture, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastVideo(broadcastList: string[], video: ViberTypes.Video, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastFile(broadcastList: string[], file: ViberTypes.File, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastContact(broadcastList: string[], contact: ViberTypes.Contact, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastLocation(broadcastList: string[], location: ViberTypes.Location, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastURL(broadcastList: string[], url: string, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastSticker(broadcastList: string[], stickerId: number, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    broadcastCarouselContent(broadcastList: string[], richMedia: ViberTypes.RichMedia, options?: ViberTypes.MessageOptions): Promise<ViberTypes.BroadcastResponseData>;
    /**
     ...
     * ```
     */
    getUserDetails(id: string): Promise<ViberTypes.UserDetails>;
    /**
     ...
     * ```
     */
    getOnlineStatus(ids: string[]): Promise<ViberTypes.UserOnlineStatus[]>;
}

...
export declare type Action = PostbackAction | MessageAction | URIAction | DatetimePickerAction | CameraAction | CameraRollAction | LocationAction;
...
export declare type CarouselTemplateOptions = MessageOptions & {
    /**
     * Aspect ratio of the image. One of:
     * - `rectangle`: 1.51:1
     * - `square`: 1:1
 ...
 */
export declare type Message = (TextMessage | ImageMessage | ImagemapMessage | VideoMessage | AudioMessage | LocationMessage | StickerMessage | TemplateMessage<Template> | FlexMessage) & MessageOptions;
/**
 *
 */
declare type Area = {
...
export declare type PartialLiffApp = {
    /** LIFF app ID */
    liffId?: string;
...
export declare type LiffFeatures = {
    /**
...
export declare type NarrowcastOptions = {
    /**
...
export declare type CreateUploadAudienceGroupOptions = {
...
export declare type CreateClickAudienceGroupOptions = {
    /**
...
export declare type GetAudienceGroupsOptions = {
    /**

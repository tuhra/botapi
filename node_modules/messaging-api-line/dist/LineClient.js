...
class LineClient {
     ...
     */
    constructor(config) {
        ts_invariant_1.default(typeof config !== 'string', `LineClient: do not allow constructing client with ${config} string. Use object instead.`);
        ...
        this.dataAxios = axios_1.default.create({
        ...
        this.dataAxios.interceptors.request.use(messaging_api_common_1.createRequestInterceptor({ onRequest: this.onRequest }));
    }
    /**
     * @deprecated Use `new LineClient(...)` instead.
     */
    static connect(config) {
        warning_1.default(false, '`LineClient.connect(...)` is deprecated. Use `new LineClient(...)` instead.');
    ...
    replyText(replyToken, text, options) {
        return this.reply(replyToken, [Line_1.default.createText(text, options)]);
    }
    /**
     * Reply Image Message
     *
    ...
    replyImage(replyToken, image, options) {
        return this.reply(replyToken, [Line_1.default.createImage(image, options)]);
    }
    /**
     * Reply Video Message
     *
    ...
    replyVideo(replyToken, video, options) {
        return this.reply(replyToken, [Line_1.default.createVideo(video, options)]);
    }
    /**
     * Reply Audio Message
     *
    ...
    replyAudio(replyToken, audio, options) {
        return this.reply(replyToken, [Line_1.default.createAudio(audio, options)]);
    }
    /**
    ...
    replyLocation(replyToken, location, options) {
        return this.reply(replyToken, [Line_1.default.createLocation(location, options)]);
    }
    /**
    ...
    replySticker(replyToken, sticker, options) {
        return this.reply(replyToken, [Line_1.default.createSticker(sticker, options)]);
    }
    /**
    ...
    replyImagemap(replyToken, altText, imagemap, options) {
        return this.reply(replyToken, [
            Line_1.default.createImagemap(altText, imagemap, options),
        ]);
    }
    /**
     * Reply Flex Message
    ...
    replyFlex(replyToken, altText, flex, options) {
        return this.reply(replyToken, [Line_1.default.createFlex(altText, flex, options)]);
    }
    /**
    ...
    replyTemplate(replyToken, altText, template, options) {
        return this.reply(replyToken, [
            Line_1.default.createTemplate(altText, template, options),
        ]);
    }
    /**
    ...
    replyButtonTemplate(replyToken, altText, buttonTemplate, options) {
        return this.reply(replyToken, [
            Line_1.default.createButtonTemplate(altText, buttonTemplate, options),
        ]);
    }
    /**
     * Reply Button Template Message
    ...
    replyConfirmTemplate(replyToken, altText, confirmTemplate, options) {
        return this.reply(replyToken, [
            Line_1.default.createConfirmTemplate(altText, confirmTemplate, options),
        ]);
    }
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    replyCarouselTemplate(replyToken, altText, columns, options = {}) {
        return this.reply(replyToken, [
            Line_1.default.createCarouselTemplate(altText, columns, options),
        ]);
    }
    /**
    ...
    replyImageCarouselTemplate(replyToken, altText, columns, options) {
        return this.reply(replyToken, [
            Line_1.default.createImageCarouselTemplate(altText, columns, options),
        ]);
    }
    /**
     * Push Message
    ...
    pushText(to, text, options) {
        return this.push(to, [Line_1.default.createText(text, options)]);
    }
    /**
     * Push Image Message
     *
    ...
    pushImage(to, image, options) {
        return this.push(to, [Line_1.default.createImage(image, options)]);
    }
    /**
     * Push Video Message
     *
    ...
    pushVideo(to, video, options) {
        return this.push(to, [Line_1.default.createVideo(video, options)]);
    }
    /**
     * Push Audio Message
     *
    ...
    pushAudio(to, audio, options) {
        return this.push(to, [Line_1.default.createAudio(audio, options)]);
    }
    /**
    ...
    pushLocation(to, location, options) {
        return this.push(to, [Line_1.default.createLocation(location, options)]);
    }
    /**
    ...
    pushSticker(to, sticker, options) {
        return this.push(to, [Line_1.default.createSticker(sticker, options)]);
    }
    /**
    ...
    pushImagemap(to, altText, imagemap, options) {
        return this.push(to, [Line_1.default.createImagemap(altText, imagemap, options)]);
    }
    /**
     * Push Flex Message
     *
    ...
    pushFlex(to, altText, flex, options) {
        return this.push(to, [Line_1.default.createFlex(altText, flex, options)]);
    }
    /**
    ...
    pushTemplate(to, altText, template, options) {
        return this.push(to, [Line_1.default.createTemplate(altText, template, options)]);
    }
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    pushCarouselTemplate(to, altText, columns, options = {}) {
        return this.push(to, [
            Line_1.default.createCarouselTemplate(altText, columns, options),
        ]);
    }
    ...
    multicastText(to, text, options) {
        return this.multicast(to, [Line_1.default.createText(text, options)]);
    }
    /**
    ...
    multicastImage(to, image, options) {
        return this.multicast(to, [Line_1.default.createImage(image, options)]);
    }
    /**
    ...
    multicastVideo(to, video, options) {
        return this.multicast(to, [Line_1.default.createVideo(video, options)]);
    }
    /**
    ...
    multicastAudio(to, audio, options) {
        return this.multicast(to, [Line_1.default.createAudio(audio, options)]);
    }
    /**
    ...
    multicastLocation(to, location, options) {
        return this.multicast(to, [Line_1.default.createLocation(location, options)]);
    }
    /**
    ...
    multicastSticker(to, sticker, options) {
        return this.multicast(to, [Line_1.default.createSticker(sticker, options)]);
    }
    /**
    ...
    multicastFlex(to, altText, flex, options) {
        return this.multicast(to, [Line_1.default.createFlex(altText, flex, options)]);
    }
    /**
     ...
     * @returns Returns status code `200` and an empty JSON object.
     */
    multicastCarouselTemplate(to, altText, columns, options = {}) {
        return this.multicast(to, [
            Line_1.default.createCarouselTemplate(altText, columns, options),
        ]);
    }
    ...
    getMessageContentStream(messageId) {
        return this.dataAxios
            .get(`/v2/bot/message/${messageId}/content`, {
            responseType: 'stream',
        })
    ...
    getGroupMemberIds(groupId, start) {
        return this.axios
            .get(`/v2/bot/group/${groupId}/members/ids${start ? `?start=${start}` : ''}`)
            .then((res) => res.data, handleError);
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                const { memberIds, next, } = // eslint-disable-next-line no-await-in-loop
                 yield this.getGroupMemberIds(groupId, continuationToken);
    ...
    getRoomMemberIds(roomId, start) {
        return this.axios
            .get(`/v2/bot/room/${roomId}/members/ids${start ? `?start=${start}` : ''}`)
            .then((res) => res.data, handleError);
    }
    /**
    ...
    getAllRoomMemberIds(roomId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                const { memberIds, next, } = // eslint-disable-next-line no-await-in-loop
                 yield this.getRoomMemberIds(roomId, continuationToken);
                allMemberIds = allMemberIds.concat(memberIds);
                continuationToken = next;
            } while (continuationToken);
            return allMemberIds;
    ...
    uploadRichMenuImage(richMenuId, image) {
        ...
        ts_invariant_1.default(type && (type.mime === 'image/jpeg' || type.mime === 'image/png'), 'Image must be `image/jpeg` or `image/png`');
        return this.dataAxios
    ...
    issueLinkToken(userId) {
        ...
        return this.axios
            .post(`/v2/bot/user/${userId}/linkToken`, null)
            .then((res) => res.data, handleError);
    }
    /**
     * Get Account link
     ...
     */
    createImpAudienceGroup(description, requestId) {
        return this.axios
     ...
     */
    setDescriptionAudienceGroup(description, audienceGroupId) {
        return this.axios
    ...
    getAudienceGroups(options = {}) {
        const query = querystring_1.default.stringify(Object.assign({ page: 1 }, options));
        return this.axios
